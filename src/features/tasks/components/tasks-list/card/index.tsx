    ...
    <li key={task.id} className={styles.taskCard} data-priority={task.priority}>
      ...
      <div className={styles.taskCardHeader}>
        <div className={styles.cardTitleGroup}>
          ...
          {/* Metadados compactos — linha única */}
      ...
      <div className={styles.cardBody}>
        ...
        {/* ── Progresso (Nível 4) — barra compacta ── */}
        {totalSteps > 0 && (
          <div className={styles.stepsCompact}>
            ...
            {/* Passos expandidos (Progressive Disclosure) */}
            {showSteps && (
        ...
        {/* ── Descrição (Nível 5 — Progressive Disclosure) ── */}
        {task.description && (
